# Adversarial Benchmark Results — v4.32.2

> **Docs-only patch (README "What it catches well" updated).** No guard code changed from v4.32.0. Corpus results are identical; this file exists to satisfy the G8 gate.
